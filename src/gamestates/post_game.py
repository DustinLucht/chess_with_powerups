...
class PostGame(BaseState):
    ...
    def __init__(self):
        ...
        self.outcome_text_rect = self.outcome_text.get_rect(center=self.screen_rect.center)
    ...
    def get_event(self, event):
        if event.type == pygame.QUIT:
            ...
            mouse_pos = pygame.mouse.get_pos()
            if self.restart_button.collidepoint(mouse_pos):
                self.restart_text = self.font.render("Start", True, pygame.Color("blue"))
            else:
                self.restart_text = self.font.render("Start", True, pygame.Color("black"))
            if self.back_button.collidepoint(mouse_pos):
                self.back_text = self.font.render("Einstellungen", True, pygame.Color("blue"))
            else:
                self.back_text = self.font.render("Einstellungen", True, pygame.Color("black"))
